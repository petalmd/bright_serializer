...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/Bhacaz/bright_serializer'
    spec.metadata['changelog_uri'] = 'https://github.com/Bhacaz/bright_serializer/blob/master/CHANGELOG.md'
  else
